...
//   Phase 6: phaseFade — more clouds day/dusk, fewer clouds at the cycle start
...
float cloudDensity(vec2 uv, float t, float phase01, out float base, float detailLOD) {
    ...
    // Phase 6: cloud density: low near start/dawn, high at day/dusk, slightly less at very end
